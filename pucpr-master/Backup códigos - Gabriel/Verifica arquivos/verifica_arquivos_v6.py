...
def lista_matrizes(root):
    ...
    for dirpath, dirnames, filenames in os.walk(root):
        ...
        if len(prof) <= 1 or prof == 'ANTIGO' or 'HIPS ' in prof or 'NOVA PASTA' in prof or 'TERMO' in prof:
            continue
        ...
        for file in filenames:
            if file == filenames[-1]:
                docs_existentes += file
            else:
                docs_existentes += f'{file}, '
    ...
    dados = {'Docente': lista_profs,
             ...
             'Documentos Existêntes': lista_doc}
