'''
Script realiza uma verificação de equivalência comparando por meio da carga horária das disciplinas base e disciplinas de equivalencia indicando, ao final,
as disciplinas e suas respectivas equivalência.
Obs: Esse script é realizado com a entrada de apenas um Excel
