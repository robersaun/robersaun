'''
Script recebe um excel com as aulas e recebe uma planilha PARA (template), esse script realiza a conversão dos dados para que seja possível salvá-los nesse template.
