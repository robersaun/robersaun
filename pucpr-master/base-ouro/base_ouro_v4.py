...
def main():
    # TODO: Adicionar a escola da disciplina com base no CR_Disciplina
    ...
    #TODO: Anotação de onde q foi alterado
    df_disciplinas = pd.read_excel(relatorio_disciplinas)
    df_disciplinas = df_disciplinas[[
        'CODIGO', 'TURMA_BASE', 'DISCIPLINA', 'TURMA_DISCIPLINA', 'DIVISAO', 'DIVISAO2'
    ]]
    ...
    df_joined = df_joined[['Estabelecimento', 'Escola', 'Centro de Resultado', 'Curso', 'Série', 'Matrícula',
                           'Nome Completo', 'CPF', 'Data de Nascimento', 'E-mail', 'Telefone Celular',
                           'Situação Acadêmica',
                           'Tipo de Ingresso', 'Turma', 'Turno', 'Gênero',
                           # dados disciplina
                           'DISCIPLINA', 'TURMA_DISCIPLINA', 'DIVISAO', 'DIVISAO2']]
