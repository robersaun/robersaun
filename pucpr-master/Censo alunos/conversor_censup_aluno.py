'''
O código é utilizado para realizar a escrita, em um arquivo de texto, dos dados dos alunos e os seus vínculos. 
Este código possui 1 função para tratar o cpf e 2 funções para realizar o tratamento do formato da data (datetime). Para que isso ocorra, 
ele recebe um excel com informações dos alunos.
Obs: Os dados dos alunos devem estar sempre na primeira página do arquivo e seus vínculos na segunda página. 
A coluna corresposndente a data de nascimento do aluno, não poderá ter sua posição alterada.
